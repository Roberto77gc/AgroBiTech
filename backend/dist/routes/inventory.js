...
const inventoryBatchEndpoint_1 = require("../services/inventoryBatchEndpoint");
...
router.get('/by-products', inventoryBatchEndpoint_1.getInventoryByProducts);
router.get('/movements', inventoryController_2.listMovements);
...
router.post('/migrate/legacy', inventoryController_1.migrateLegacyInventory);
